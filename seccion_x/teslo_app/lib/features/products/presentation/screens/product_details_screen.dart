...
class _ProductView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final productForm = ref.watch(productStateNotifierProvider(product));
      ...
      child: Column(
        ...
        children: [
          ...
          CustomProductField(
            ...
            onChanged: (value) => ref
                .read(productStateNotifierProvider(product).notifier)
...
class _SizeSelector extends StatelessWidget {
  ...
  const _SizeSelector({required this.selectedSizes, this.onSizesChange});
...
class _GenderSelector extends StatelessWidget {
  ...
  const _GenderSelector({required this.selectedGender, this.onGenderChanged});
